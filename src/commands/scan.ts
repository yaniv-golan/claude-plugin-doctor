...
import { checkCoworkMirror } from "../caches/cowork-mirror.js";
import { snapshotCoworkMirror } from "../caches/cowork-mirror.js";
import { checkInstallSnapshot, readPluginSubdir } from "../caches/install-snapshot.js";
import { snapshotInstallSnapshot } from "../caches/install-snapshot.js";
...
import { type RpmEntry, parseRpmManifest } from "../rpm-manifest.js";
...
function extractRecommendation(checks: Record<Layer, CheckResult>, layerList: readonly Layer[]) {
